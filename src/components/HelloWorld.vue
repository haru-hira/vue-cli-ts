  ...
  <v-container>
    <v-row>
      <v-col cols="12">
          ...
          <v-dialog v-model="dialog" persistent scrollable width="500">
            ...
            <v-card>
              ...
              <v-card-text style="height: 300px;">
                <v-btn color="primary" @click="subDialog = true">
                  Sub Dialog
                </v-btn>
        ...
        <v-row>
          <v-speed-dial v-model="fab" top left direction="right" transition="slide-x-transition">
        ...
        <v-row>
          <v-carousel cycle height="400" hide-delimiter-background show-arrows-on-hover>
            <v-carousel-item v-for="(slide, i) in slides" :key="i">
              <v-sheet :color="slideColors[i]" height="100%">
      ...
      <v-col cols="12">
        <v-expansion-panels accordion hover focusable>
          <v-expansion-panel v-for="(item, i) in 4" :key="i" :disabled="i === 2">
      ...
      <v-col cols="12">
        ...
        <v-chip class="ma-2" close color="teal" text-color="white" @click:close="closeChip">
          <v-avatar left>
            <v-icon>mdi-checkbox-marked-circle</v-icon>
          </v-avatar>
          Confirmed
        </v-chip>
        <v-chip class="ma-2" close color="teal" text-color="white" close-icon="mdi-delete" @click:close="closeChip">
          <v-avatar left>
            <v-icon>mdi-checkbox-marked-circle</v-icon>
          </v-avatar>
          Confirmed
        ...
        <v-chip class="ma-2" close color="indigo darken-3" outlined @click:close="closeChip">
...
export default Vue.extend({
  ...
  data: () => ({
    ...
    subDialog: false,
    fab: false,
    slideColors: ['indigo', 'warning', 'pink darken-2', 'red lighten-1', 'deep-purple accent-4'],
  ...
  methods: {
    ...
    incrementNumber2(value: { hoge: string; piyo: string; fuga: string }) {
      console.log(value);
    },
    closeChip() {
